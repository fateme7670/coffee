"use client";
import { DeletewishlistFromServer } from "@/Redux/features/wishlist";
...
const WhishList = ({ img, name, price, score, productID }: Props) => {
  ...
  const removeProduct = () => {
    swal({
      ...
      if (result) {
        dispatch(DeletewishlistFromServer({ id: productID })).then((data) => {
      ...
      <div className="relative">
        ...
        <div className="w-full mt-5">
          <button
            ...
            className="bg-redprimary-500 px-5 py-1 w-full text-white hover:bg-redprimary-500/50"
          >
            حذف محصول
          </button>
        </div>
